...
public class StatusBarUtil {
    ...
    public static final String VIEW_TAG = "VIEW_BAR";
    ...
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            statusView.setTag(VIEW_TAG);
            // 添加 statusView 到布局中
            ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();
            if(decorView.findViewWithTag(VIEW_TAG) == null) {
    ...
    /**
     * 添加移除StatusBarView 方法
     * @param activity
     */
    public static void removeStatusBarView(Activity activity) {
        ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();
        View view = decorView.findViewWithTag(StatusBarUtil.VIEW_TAG);
        KLog.d("statusbar view = " + view);
        if (view != null) {
